 ...
 * @author root
 */
public class QpostSuccessServlet extends HttpServlet {
 ...
 protected void processRequest(HttpServletRequest request, HttpServletResponse response)
  ...
  try (PrintWriter out = response.getWriter()) {
   ...
   out.println("<html>");
   out.println("<head>");
out.println("<meta http-equiv='refresh' content='3; url=PostQueryServlet'>");   
...
"	margin:auto;	}</style>");
   ...
   out.println("<title>QpostSuccessServlet</title>");   
   out.println("</head>");
   out.println("<body>");
...
out.println("  <strong>Success!</strong> Query Posted Successfully.");
out.println("</div>");
